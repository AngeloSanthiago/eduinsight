#Como configurar o Eclipse para trabalho com o repositório GitHub
 Configurar o nome do usuário e e-mail para commits
...
##Parte 1 - Configurar um projeto Maven/Java no Eclipse
Abrir o eclipse e criar um projeto do tipo mave/java básico,
